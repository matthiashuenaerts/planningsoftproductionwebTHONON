...
const Navbar = () => {
  ...
  return (
    <div className="h-full px-3 py-4 overflow-y-auto bg-blue-700 text-white">
      <div className="flex flex-col h-full justify-between">
        <div>
          <h2 className="px-2 py-3 text-lg font-semibold mb-2">PhaseFlow</h2>
          <ul className="space-y-2 font-medium">
            <li>
              <NavLink to="/" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
                <Home className="w-5 h-5 text-white group-hover:text-white" />
                <span className="ml-3">Dashboard</span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/projects" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
                <LayoutDashboard className="w-5 h-5 text-white group-hover:text-white" />
                <span className="ml-3">Projects</span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/workstations" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
                <Truck className="w-5 h-5 text-white group-hover:text-white" />
                <span className="ml-3">Workstations</span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/personal-tasks" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
                <ListChecks className="w-5 h-5 text-white group-hover:text-white" />
                <span className="ml-3">Personal Tasks</span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/daily-tasks" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
                <ListChecks className="w-5 h-5 text-white group-hover:text-white" />
            ...
            {isAdminOrManager && (
              <li>
                <NavLink to="/planning" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
            ...
            {isAdminOrManager && (
              <li>
                <NavLink to="/orders" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
            ...
            {isAdminOrManager && (
              <li>
                <NavLink to="/rush-orders" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
                  <PackagePlus className="w-5 h-5 text-white group-hover:text-white" />
            ...
            <li>
              <NavLink to="/settings" className="flex items-center p-2 rounded-lg hover:bg-blue-800 group">
        ...
        <div className="mt-auto border-t border-blue-600 pt-2">
          ...
          <button 
            onClick={logout} 
            className="flex w-full items-center p-2 rounded-lg hover:bg-blue-800 group text-white"
          >
